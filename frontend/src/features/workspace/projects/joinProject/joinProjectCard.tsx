...
function JoinProjectCard() {
  return (
    <div className="flex flex-col gap-5 w-64 h-80 px-2  rounded-lg border border-dashed border-foreground/30 shadow-lg items-center justify-center cursor-pointer">
      <PlusCircle size={40} />
